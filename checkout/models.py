import uuid  # used to generate unique numbers
...
class Order(models.Model):
    ...
    def _generate_order_number(self):
        '''
        Generate a random, unique 32 chars number using UUID
        '''
...
class OrderLineItem(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        '''
        self.lineitem_total = self.product.market_price * self.quantity
        super().save(*args, **kwargs)
